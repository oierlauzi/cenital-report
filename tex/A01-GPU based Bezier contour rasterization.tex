...
\begin{figure}[hbtp]
    \centering
    \subfigure[Filled]{\includegraphics[width=0.45\textwidth]{Whale}}
    \subfigure[Outline with control points]{\includegraphics[width=0.45\textwidth]{Whale Control}}
...
\begin{figure}[hbtp]
    \centering
    \subfigure[Intersections]{\includegraphics[width=0.45\textwidth]{Whale Control Intersections}}
    \subfigure[After splitting]{\includegraphics[width=0.45\textwidth]{Whale Control Segmented Intersections}}
...
\begin{figure}[hbtp]
    \centering
    \includegraphics[width=\textwidth]{Whale Triangulated}
...
\begin{figure}[hbtp]
    \centering
    \includegraphics[width=\textwidth]{Whale Crop}
